...
use BB\Repo\LargeProjectRepository;
...
class LargeProject
{
    ...
    const VOLUME_ALLOWED = 1;

    public function __construct(LargeProjectRepository $LargeProjectRepository, PaymentRepository $paymentRepository)
    {
    ...
    public function setMember($memberId)
    {
        ...
        $this->memberBoxes = $this->LargeProjectRepository->getMemberBoxes($this->memberId);
