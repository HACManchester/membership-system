...
@section('content')
            ...
            <div class="well">
                <div class="row">
                            ...
                            @if ($userInduction)
                                @if (!$userInduction->trained)
                                    <div class="well infobox">
                                        ...
                                        @else
                                            <p>You have requested training for this equipment. To get trained, ask on the
                                                forum or on Telegram.</p>
                                        @endif
                                    </div>
                                @endif
                            @else
                                <div class="well infobox">
                                    ...
                                    <ul>
                                        ...
                                        <li>Inductions are given by other members, request an induction for details on next
                                            steps.</li>
                                    </ul>
                                    ...
                                    @if ($equipment->accepting_inductions)
                                        ...
                                        @else
                                            <form method="POST"
                                                action="{{ route('equipment_training.create', ['equipment' => $equipment]) }}">
                                                @csrf
                    ...
                    <div class="col-sm-6">
                        ...
                        @else
                            <p>No specific PPE is required. You must still be aware of risks and use relevent PPE to
                        ...
                        @if ($equipment->hasPhoto())
                            ...
                            @for ($i = 0; $i < $equipment->getNumPhotos(); $i++)
                                <img src="{{ $equipment->getPhotoUrl($i) }}" width="120" data-toggle="modal"
                                    data-target="#image{{ $i }}" style="margin:3px 1px; padding:0;" />
                    ...
                    <div class="col-sm-12">
                        <div class="infobox well">
                            ...
                            @if ($equipment->docs)
                                ...
                                <a target="_blank" class="btn btn-success" href="{{ $equipment->docs }}">View
                                    documentation</a>
                            @endif
                        </div>
                ...
                <div class="well">
                    ...
                    @can('train', $equipment)
                        <a class="btn btn-danger"
                            href="{{ route('notificationemail.equipment', [$equipment->slug, 'trainer']) }}">
                            📧 Email
                        </a>
                    @endcan
                </div>
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="well">
                    ...
                    @can('train', $equipment)
                        <a class="btn btn-danger"
                            href="{{ route('notificationemail.equipment', [$equipment->slug, 'trained']) }}">
                            📧 Email
                        </a>
                    @endcan
                </div>
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="well infobox">
                    ...
                    @can('train', $equipment)
                        <a class="btn btn-danger"
                            href="{{ route('notificationemail.equipment', [$equipment->slug, 'awaiting_training']) }}">
                            📧 Email
                        </a>
                    @endcan
                </div>
    ...
    <div class="row">
        <div class="col col-sm-12">
            <div class="panel panel-warning">
                ...
                <div class="panel-body">If something is wrong or missing on this page, please raise the issue on the Forum
                    or Telegram.</div>
            </div>
        </div>
    </div>
    ...
    @can('delete', $equipment)
        <div class="modal fade" tabindex="-1" role="dialog" id="equipment-deletion-modal">
            <form class="modal-dialog" role="document" action="{{ route('equipment.destroy', $equipment) }}"
                method="POST">
                {{ csrf_field() }}
                {{ method_field('DELETE') }}
