...
<body>
    <h1>Welcome to the new Hackspace Manchester Member System</h1>

    <p>
        You have been setup in the new Hackspace Manchester Member System, this is where your subscription and other
    ...
    <p>
        ...
        https://members.hacman.org.uk/password/forgotten
    </p>

    <h3>Your Details</h3>
    <p>
        Please take a look at your details, We have done our best to import everything from the various places
    ...
    <p>
        <br />
        <br />
        If you have any questions please get in touch with me or any of the other board.
    </p>

    <p>
        Thanks,<br />
        <br />
        The Hackspace Manchester board<br />
