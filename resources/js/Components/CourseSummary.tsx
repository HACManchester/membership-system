...
import { Typography, Box, Card, CardContent, Chip, Link, Stack, Alert } from '@mui/material';
      ...
      >
        <CardContent sx={{ flexGrow: 1 }}>
          ...
          >
            ...
            {isUserTrained && <CheckCircleIcon color="success" sx={{ ml: 1 }} />}
          </Box>
            ...
            {canSeeNonLiveCourses && !course.live && (
              <Alert severity="info" sx={{ py: 0.5 }}>
                <Typography variant="body2">
                  <strong>Not yet live:</strong> This course is in development. Regular members
                  cannot see it yet.
                </Typography>
              </Alert>
            )}
