          ...
          <Table>
            <TableHead>
              <TableRow>
                ...
                {isUserTrained && <TableCell>Access Code</TableCell>}
                  ...
                  <TableCell>
                    ...
                    >
                      {equipmentItem.working ? (
                        <Chip label="Working" size="small" color="success" variant="filled" />
                      ) : (
                        <Chip label="Out of action" size="small" color="error" variant="filled" />
                      )}
                      {equipmentItem.permaloan && (
                        <Chip label="Permaloan" size="small" color="warning" variant="filled" />
                      )}
                    </Box>
                  </TableCell>
